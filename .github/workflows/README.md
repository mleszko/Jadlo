...
1. **Performance**: Route generation must complete within time limits
   - 30km routes: <60 seconds
   - 60km routes: <120 seconds  
   - 100km routes: <180 seconds (3 minutes)
...
**Timeout:** Each test step has its own timeout (3-5 minutes) appropriate for the route distance being tested.
